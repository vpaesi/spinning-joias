      ...
      <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg p-6 md:p-10">
        ...
        <div className="space-y-4">
          <div className="border-b pb-2">
            ...
            <p>
              A Spinning Joias acompanha os mais diversos eventos de patinação{" "}
              <b>desde 2012</b>. Desde o início, nosso objetivo foi criar peças
            ...
            <p>
              ...
              diferentes produtos para usar fora da quadra de patinação, como
          ...
          <div className="border-b pb-2">
            ...
            <p>
              Encantar nossos clientes com joias de qualidade, design marcante e
          ...
          <div className="border-b pb-2">
            ...
            <p>
              Ser referência nacional em joias que unem elegância e
          ...
          <div className="border-b pb-2">
            ...
            <p>
              Nossos valores são a base de tudo o que fazemos. Eles nos guiam em
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                joia ou produto pode transmitir, criando peças que tocam o
                coração.
              </li>
              <li>
                <b>P</b>recisão: Cada detalhe conta. Buscamos a perfeição em
                cada peça, garantindo qualidade e durabilidade.
              </li>
              <li>
                <b>I</b>novação: Estamos sempre em movimento, buscando novas
                tendências e tecnologias para surpreender nossos clientes.
              </li>
              <li>
                <b>N</b>obreza: Valorizamos a autenticidade e a singularidade de
                cada cliente, promovendo respeito e ética em todas as nossas
                ações.
              </li>
            </ul>
          </div>
